...
ImagenX = DirClien & "\GRAFICOS\" & GrhData(Gr).FileNum & ".png"
...
For i = 0 To 3
    ...
    HX(i).Caption = Gr
    If LenB(Dir(DirClien & "\GRAFICOS\" & GrhData(Gr).FileNum & ".png", vbArchive)) = 0 Then Exit Sub
    Call ConvertFileImage(DirClien & "\GRAFICOS\" & GrhData(Gr).FileNum & ".png", App.Path & "\temp\" & FileName & ".jpg", 100)
    
    'ImagenX = LoadPicture(App.Path & "\temp\" & FileName & ".jpg")
    HDX(i).Picture = LoadPicture(App.Path & "\temp\" & FileName & ".jpg")
